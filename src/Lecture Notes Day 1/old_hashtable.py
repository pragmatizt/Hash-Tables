...
class LinkedPair:
    def __init__(self, key, value):
        ...
        self.value = value
        self.next = None
    def __repr__(self):                          # Added during lecture
...
class HashTable:
    ...
    # _ usually means private function, not meant to be used outside of class itself
    def _hash(self, key):
        '''
    ...
    def _hash_mod(self, key):
        ...
        # runs the _hash functino for you, then modulos it
...
if __name__ == "__main__":
    ...
    print(ht.storage) # delete after testing
